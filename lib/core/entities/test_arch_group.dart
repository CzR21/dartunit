...
void testArchGroup(
  ...
  group(groupName, () {
    ...
    // --- Severity: set synchronously so testArch captures it at registration ---
    final previousSeverity = _activeGroupSeverity;
    _activeGroupSeverity = severity;

    body();

    // Restore after body() so sibling groups don't inherit this severity.
    _activeGroupSeverity = previousSeverity;
  });
}
