...
class HtmlReporter {
  ...
  String generate(
    ...
    final criticalCount =
        violations.where((v) => v.severity == RuleSeverity.critical).length;
    final errorCount =
        violations.where((v) => v.severity == RuleSeverity.error).length;
    final warningCount =
        violations.where((v) => v.severity == RuleSeverity.warning).length;
    final infoCount =
        violations.where((v) => v.severity == RuleSeverity.info).length;
